...
export const metadata: Metadata = generateSEOHead({
    title: 'Contact Ganishkha Sri Crackers | Top Sivakasi Cracker Dealers 2026',
    description: 'Contact Ganishkha Sri Crackers in Sivakasi. Phone: 82488 17401, 81481 65318. Top cracker dealers for 100% genuine Sivakasi crackers and Diwali 2026 online crackers. Delivery across Jammu & Kashmir, West Bengal, Karnataka, Kerala, Tamil Nadu, Andhra Pradesh, Telangana, Maharashtra, Uttar Pradesh & Uttarakhand.',
    canonical: 'https://www.ganishkhasricrackers.in/contact',
});

const contactFaqs = [
    {
        question: 'How do I contact Ganishkha Sri Crackers?',
        answer: 'You can call or WhatsApp us on 82488 17401 or 81481 65318. Our shop is located at Chinnakamanpatti, Sattur Road, Sivakasi - 626189.',
    },
    {
        question: 'Do you deliver Sivakasi crackers across India?',
        answer: 'Yes, we deliver 100% genuine Sivakasi crackers and Diwali fireworks across all Indian states including Jammu & Kashmir, West Bengal, Karnataka, Kerala, Tamil Nadu, Andhra Pradesh, Telangana, Maharashtra, Uttar Pradesh and Uttarakhand. Tamil Nadu and Pondicherry minimum order is ₹3000; other states minimum order is ₹6000.',
    },
    {
        question: 'What is the delivery time for online cracker orders?',
    ...
    },
    {
        ...
        answer: 'Yes. Ganishkha Sri Crackers deals with top Sivakasi brands since 2010. We source 100% genuine crackers from trusted manufacturers in Chinnakamanpatti, Sivakasi.',
    },
    {
        question: 'Can I order pattasu online from Ganishkha Sri Crackers?',
        answer: 'Yes. You can order pattasu online by browsing our catalog, adding products to cart and checking out. For help, call or WhatsApp 82488 17401 / 81481 65318.',
    },
];
        ...
        <>
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-lg text-white leading-relaxed">
                                            <p className="mb-2"><strong>All India Delivery:</strong> We deliver across Jammu & Kashmir, West Bengal, Karnataka, Kerala, Tamil Nadu, Andhra Pradesh, Telangana, Maharashtra, Uttar Pradesh, Uttarakhand and all other states</p>
            ...
            <section className="bg-gray-100 py-12 px-4">
                <div className="container mx-auto max-w-4xl">
                    <h2 className="text-2xl sm:text-3xl font-bold text-center mb-8 text-slate-900">Frequently Asked Questions</h2>
