...
export const metadata: Metadata = generateSEOHead({
    title: 'Ganishkha Sri Crackers | Buy Diwali Crackers Online 2026 | Sivakasi',
    description: 'Buy Diwali crackers online 2026 directly from Sivakasi. 100% genuine firecrackers from top cracker dealers. Best price list for sparklers, flower pots, bombs, rockets, aerial shots. Top online crackers shop with delivery across Jammu & Kashmir, West Bengal, Karnataka, Kerala, Tamil Nadu, Andhra Pradesh, Telangana, Maharashtra, Uttar Pradesh & Uttarakhand.',
    canonical: `${siteUrl}/diwali-crackers-online`,
    keywords: 'diwali crackers, buy diwali crackers online, diwali crackers online, diwali crackers 2026, diwali 2026, diwali 2026 crackers, diwali fireworks, sivakasi crackers, genuine sivakasi crackers, sivakasi diwali crackers, diwali crackers wholesale, diwali crackers price list, diwali pattasu, diwali patakha, diwali gift boxes, diwali sparklers, diwali flower pots, diwali bombs, diwali rockets, online crackers, online crackers india, top cracker dealers, top cracker dealers in sivakasi, ganishkha sri crackers, chinnakamanpatti crackers, tamil nadu crackers, pattasu online, diwali pattasu online, buy pattasu online, order pattasu online',
});

const faqs = [
    {
        question: 'How to order Diwali crackers online from Ganishkha Sri Crackers?',
        answer: 'Browse our Sivakasi crackers price list, add sparklers, flower pots, bombs, rockets, aerial shots or gift boxes to your cart, and checkout. Our team will call you to confirm transport details for all-India delivery.',
    },
    {
        question: 'Do you sell 100% genuine Sivakasi crackers at wholesale price?',
        answer: 'Yes. Ganishkha Sri Crackers is a Sivakasi wholesale crackers supplier dealing with top brands since 2010. Our price list shows 80% discount on MRP for most items, giving you factory-direct rates.',
    },
    {
        question: 'Do you deliver Diwali crackers across India?',
        answer: 'Yes. We deliver across Jammu & Kashmir, West Bengal, Karnataka, Kerala, Tamil Nadu, Andhra Pradesh, Telangana, Maharashtra, Uttar Pradesh, Uttarakhand and all other states. Goods are booked to your nearest transport hub on a "to pay" basis.',
    },
    {
    ...
    {
        question: 'Are your crackers genuine, safe and ISO certified?',
        answer: 'Yes. We source only 100% genuine Sivakasi crackers from trusted brands like Winstar, Sky King, Annai, Vadivel, Hayagrivar, Vanitha, Sri Vijay, Dass, Varshini, Nayagi, Deepam, Sri Krishna, Mother\'s and Suryakala. All products meet safety standards.',
    },
    {
    ...
    {
        question: 'Can I buy Diwali pattasu online for 2026?',
        answer: 'Yes. You can buy Diwali pattasu online for 2026 from Ganishkha Sri Crackers. Choose from sparklers, flower pots, bombs, rockets, aerial shots and gift boxes at wholesale prices.',
    },
    {
        question: 'Where to order pattasu online for Diwali?',
        answer: 'Order pattasu online for Diwali from Ganishkha Sri Crackers. We are a top Sivakasi cracker dealer with 100% genuine products, safe packaging and delivery across India.',
    },
];
...
export default function DiwaliCrackersOnlinePage() {
    ...
    return (
        <main className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
            ...
            100% Genuine Sivakasi Crackers • Top Brands Since 2010 • All India Delivery
                    </p>
                    <p className="text-gray-300 max-w-2xl mx-auto">
            Shop 100% genuine Sivakasi fireworks online from Ganishkha Sri Traders. Top brands since 2010 with best crackers price list 2026 for sparklers, flower pots, bombs, rockets, aerial shots, gift boxes and more. Delivery across Jammu & Kashmir, West Bengal, Karnataka, Kerala, Tamil Nadu, Andhra Pradesh, Telangana, Maharashtra, Uttar Pradesh & Uttarakhand.
                    </p>
                    <div className="mt-8">
                        <Link
                            href="/"
            ...
            brings you 100% genuine Sivakasi crackers directly from the manufacturing hub of India.
            Since 2010, we have served customers across Jammu & Kashmir, West Bengal, Karnataka, Kerala, Tamil Nadu,
            Andhra Pradesh, Telangana, Maharashtra, Uttar Pradesh, Uttarakhand and all other states.
                    </p>
                    <p>
