...
export default async function CategoryPage({ params }: { params: Promise<{ slug: string }> }) {
    ...
    const faqJsonLd = {
        ...
        mainEntity: [
            ...
            {
                '@type': 'Question',
                name: `Can I buy ${categoryName} pattasu online?`,
                acceptedAnswer: {
                    '@type': 'Answer',
                    text: `Yes. You can buy ${categoryName} pattasu online from Ganishkha Sri Crackers. We deliver 100% genuine Sivakasi ${categoryName} across Tamil Nadu and all over India.`,
                },
            },
        ],
    };
    ...
    return (
        <main className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
            ...
            <section className="py-12 px-4 sm:px-6 lg:px-8 bg-white border-y border-gray-200">
                <div className="container mx-auto max-w-6xl">
                    <h2 className="text-2xl font-bold mb-6 text-center">Related Crackers Categories</h2>
                        ...
                        {categories
                            ...
                            .map((c) => (
                                <Link
                                    ...
                                    className="px-4 py-2 bg-orange-50 text-orange-800 rounded-full border border-orange-200 hover:bg-orange-100 hover:border-orange-400 transition-colors text-sm font-medium"
                                >
                                    {c.name}
                                </Link>
                            ))}
