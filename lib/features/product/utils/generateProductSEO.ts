...
import { getProductUrl } from './productUrl';
...
export function generateProductSEO(product: ProductModel, id?: string): ProductSEO {
    ...
    const keywordTokens = dedupe([
        ...
        'online crackers',
        'online crackers india',
        'top cracker dealers',
        'top cracker dealers in sivakasi',
        'Diwali crackers',
        'Diwali 2026',
        'Diwali 2026 crackers',
        'buy diwali crackers online',
        'buy diwali 2026 crackers online',
        'Deepavali pattasu',
        'diwali pattasu',
        'sivakasi pattasu',
        'pattasu online',
        'buy pattasu online',
        'sivakasi pattasu online',
        'order pattasu online',
        'wholesale crackers',
    ...
    const images = [
        ...
        ...(product.previews || [])
            ...
            .map((url: string) => (url.startsWith('http') ? url : `${siteUrl}${url}`)),
    ].filter(Boolean);
