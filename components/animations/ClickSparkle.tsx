...
function createParticles(x: number, y: number): SparkleParticle[] {
    const colors = [
...
export function ClickSparkle({ x, y, onComplete }: ClickSparkleProps) {
    ...
    const [particles, setParticles] = useState<SparkleParticle[]>(() => createParticles(x, y));
    ...
    }, [x, y, onComplete, isClient, particles]);
