...
class Firework {
    ...
    constructor({ canvasWidth, canvasHeight, colors }: FireworkOptions, particles: Particle[]) {
...
export function FireworksAnimation() {
    ...
    useEffect(() => {
        ...
        function animate() {
            ...
            if (Math.random() < 0.03) {
                fireworks.push(new Firework({ canvasWidth: canvas.width, canvasHeight: canvas.height, colors: COLORS }, particles));
            }
