            ...
            DIWALI SPECIAL
                    ...
                    <div className="grid grid-cols-3 gap-2 sm:gap-4 max-w-2xl mx-auto">
                        <div className="bg-white/10 backdrop-blur-sm rounded-lg p-2 sm:p-3 border border-white/20">
                            ...
                            <div className="text-xs sm:text-sm font-bold text-yellow-400">100% Genuine</div>
                            <div className="text-xs text-white hidden sm:block">Sivakasi Brands</div>
                        </div>
                        <div className="bg-white/10 backdrop-blur-sm rounded-lg p-2 sm:p-3 border border-white/20">
                            <Shield className="w-4 h-4 sm:w-5 sm:h-5 text-yellow-400 mx-auto mb-1" />
                            <div className="text-xs sm:text-sm font-bold text-yellow-400">Top Brands</div>
                            <div className="text-xs text-white hidden sm:block">Since 2010</div>
                        </div>
                        <div className="bg-white/10 backdrop-blur-sm rounded-lg p-2 sm:p-3 border border-white/20">
                            <Truck className="w-4 h-4 sm:w-5 sm:h-5 text-yellow-400 mx-auto mb-1" />
                            <div className="text-xs sm:text-sm font-bold text-yellow-400">PAN India</div>
                            <div className="text-xs text-white hidden sm:block">Fast Delivery</div>
                        </div>
                    </div>
                </div>
            </div>
